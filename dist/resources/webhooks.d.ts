...
export declare class WebhooksResource extends BaseResource {
    ...
    register(params: RequestBody<"webhooks.register">): Promise<void>;
    /** Get a list of registered webhooks */
    list(params?: RequestBody<"webhooks.list">): Promise<{
        data?: {
            url: string;
    ...
    unregister(params: RequestBody<"webhooks.unregister">): Promise<void>;
}
